...
### Caso 1: _actualización de datos_
...
### Caso 2: _cambio en cálculos o metodología_
...
- Hago **B**
- Hago **C**
- _Cambio en cálculos o metodología_
- Hago de nuevo **B**
- Como **C** depende de **B**, lo hago de nuevo también
:::
...
### Caso 3: _replicar un resultado_
...
- Hago **B** para grupo 1
- Hago **C** para grupo 1
- _Ahora necesito hacer lo mismo, de nuevo, para otro grupo_
- Hago **A** para grupo 2 🤨
- Hago **B** para grupo 2
- Hago **C** para grupo 2... 😵
:::
...
- Re-ejecuto los scripts para grupo 2
- Re-ejecuto los scripts  para grupo 3
...
- Hago **A, B** y **C**
- Hago 10 gráficos
- _Necesito modificar los gráficos_
- Hago el mismo cambio en cada uno de los gráficos... 😵
:::
...
::: {.incremental}
- Hago **A, B** y **C**
- Hago un script que genera 10 gráficos
- _Necesito modificar los gráficos_
- Ajusto el script y vuelvo a generar los gráficos 😌
:::
...
Al crear o modificar una columna con `mutate()` podemos usar funciones que se apliquen a una o varias columnas:
...
datos |>
  ...
  arrange(desc(personas)) |> 
  head() |> 
  mutate(total_personas = sum(personas)) |> # aplicada a una colunma
